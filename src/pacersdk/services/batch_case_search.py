...
class BatchCaseSearchService:
    ...
    def submit(self, request: BatchCaseRequest) -> BatchCaseResponse:
        ...
        """
        return cast(BatchCaseResponse, self.session.post("/cases/download", request))
    ...
    def status(self, job_id: str) -> dict:
        ...
        """
        return self.session.get(f"/cases/download/status/{job_id}")
    ...
    def download(self, job_id: str) -> dict:
        ...
        """
        return self.session.get(f"/cases/download/{job_id}")
    ...
    def delete(self, job_id: str) -> dict:
        ...
        """
        return self.session.delete(f"/cases/reports/{job_id}")
